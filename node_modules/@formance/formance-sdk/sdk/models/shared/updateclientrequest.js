...
(function (UpdateClientRequest$) {
    UpdateClientRequest$.inboundSchema = z.object({
    ...
    UpdateClientRequest$.outboundSchema = z.object({
        description: z.string().optional(),
        metadata: z.record(z.any()).optional(),
        name: z.string(),
        postLogoutRedirectUris: z.array(z.string()).optional(),
...
})(UpdateClientRequest$ || (exports.UpdateClientRequest$ = UpdateClientRequest$ = {}));

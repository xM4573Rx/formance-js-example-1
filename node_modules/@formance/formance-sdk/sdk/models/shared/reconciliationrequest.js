...
(function (ReconciliationRequest$) {
    ReconciliationRequest$.inboundSchema = z.object({
    ...
    ReconciliationRequest$.outboundSchema = z.object({
        reconciledAtLedger: z.date().transform((v) => v.toISOString()),
        reconciledAtPayments: z.date().transform((v) => v.toISOString()),
    });
})(ReconciliationRequest$ || (exports.ReconciliationRequest$ = ReconciliationRequest$ = {}));

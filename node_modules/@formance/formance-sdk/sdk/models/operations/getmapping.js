...
exports.GetMappingResponse$ = exports.GetMappingRequest$ = void 0;
...
(function (GetMappingRequest$) {
    GetMappingRequest$.inboundSchema = z.object({
        ledger: z.string(),
    });
    GetMappingRequest$.outboundSchema = z.object({
        ledger: z.string(),
    });
})(GetMappingRequest$ || (exports.GetMappingRequest$ = GetMappingRequest$ = {}));
/** @internal */
var GetMappingResponse$;
(function (GetMappingResponse$) {
    GetMappingResponse$.inboundSchema = z
        .object({
    ...
    GetMappingResponse$.outboundSchema = z
        .object({
        contentType: z.string(),
...
})(GetMappingResponse$ || (exports.GetMappingResponse$ = GetMappingResponse$ = {}));

...
exports.ReadUserResponse$ = exports.ReadUserRequest$ = void 0;
...
(function (ReadUserRequest$) {
    ReadUserRequest$.inboundSchema = z.object({
        userId: z.string(),
    });
    ReadUserRequest$.outboundSchema = z.object({
        userId: z.string(),
    });
})(ReadUserRequest$ || (exports.ReadUserRequest$ = ReadUserRequest$ = {}));
/** @internal */
var ReadUserResponse$;
(function (ReadUserResponse$) {
    ReadUserResponse$.inboundSchema = z
        .object({
    ...
    ReadUserResponse$.outboundSchema = z
        .object({
        contentType: z.string(),
...
})(ReadUserResponse$ || (exports.ReadUserResponse$ = ReadUserResponse$ = {}));

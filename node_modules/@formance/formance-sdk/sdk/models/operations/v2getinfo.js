...
exports.V2GetInfoResponse$ = void 0;
const primitives_1 = require("../../../lib/primitives");
const shared = __importStar(require("../shared"));
const z = __importStar(require("zod"));
/** @internal */
var V2GetInfoResponse$;
(function (V2GetInfoResponse$) {
    V2GetInfoResponse$.inboundSchema = z
        .object({
    ...
    V2GetInfoResponse$.outboundSchema = z
        .object({
        contentType: z.string(),
        statusCode: z.number().int(),
...
})(V2GetInfoResponse$ || (exports.V2GetInfoResponse$ = V2GetInfoResponse$ = {}));
//# sourceMappingURL=v2getinfo.js.map
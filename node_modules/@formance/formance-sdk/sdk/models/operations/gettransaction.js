...
(function (GetTransactionRequest$) {
    GetTransactionRequest$.inboundSchema = z.object({
        ledger: z.string(),
        txid: z.number().transform((v) => BigInt(v)),
    });
    GetTransactionRequest$.outboundSchema = z.object({
        ledger: z.string(),
        txid: z.bigint().transform((v) => Number(v)),
    });
})(GetTransactionRequest$ || (exports.GetTransactionRequest$ = GetTransactionRequest$ = {}));
/** @internal */
var GetTransactionResponse$;
(function (GetTransactionResponse$) {
    GetTransactionResponse$.inboundSchema = z
        .object({
    ...
    GetTransactionResponse$.outboundSchema = z
        .object({
        contentType: z.string(),
        statusCode: z.number().int(),
...
})(GetTransactionResponse$ || (exports.GetTransactionResponse$ = GetTransactionResponse$ = {}));

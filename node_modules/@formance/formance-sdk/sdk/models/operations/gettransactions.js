...
(function (GetTransactionsRequest$) {
    GetTransactionsRequest$.inboundSchema = z.object({
        cursor: z.string().optional(),
        pageSize: z.number().int().default(15),
        walletID: z.string().optional(),
    });
    GetTransactionsRequest$.outboundSchema = z.object({
        cursor: z.string().optional(),
        pageSize: z.number().int().default(15),
        walletID: z.string().optional(),
    });
})(GetTransactionsRequest$ || (exports.GetTransactionsRequest$ = GetTransactionsRequest$ = {}));
/** @internal */
var GetTransactionsResponse$;
(function (GetTransactionsResponse$) {
    GetTransactionsResponse$.inboundSchema = z
        .object({
    ...
    GetTransactionsResponse$.outboundSchema = z
        .object({
        contentType: z.string(),

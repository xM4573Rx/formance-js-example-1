...
exports.GetBalancesResponse$ = exports.GetBalancesRequest$ = void 0;
...
(function (GetBalancesRequest$) {
    GetBalancesRequest$.inboundSchema = z.object({
    ...
    GetBalancesRequest$.outboundSchema = z.object({
        address: z.string().optional(),
        after: z.string().optional(),
        cursor: z.string().optional(),
        ledger: z.string(),
...
})(GetBalancesRequest$ || (exports.GetBalancesRequest$ = GetBalancesRequest$ = {}));
/** @internal */
var GetBalancesResponse$;
(function (GetBalancesResponse$) {
    GetBalancesResponse$.inboundSchema = z
        .object({
    ...
    GetBalancesResponse$.outboundSchema = z
        .object({
...
})(GetBalancesResponse$ || (exports.GetBalancesResponse$ = GetBalancesResponse$ = {}));

...
function encodeMatrix(key, value, options) {
    ...
    pairs.forEach(([pk, pv]) => {
        ...
        else if ((0, is_plain_object_1.isPlainObject)(pv)) {
...
function encodeLabel(key, value, options) {
    ...
    pairs.forEach(([pk, pv]) => {
        ...
        if (pv === undefined) {
            ...
            const k = (options === null || options === void 0 ? void 0 : options.explode) && (0, is_plain_object_1.isPlainObject)(value) ? `${encodeString(pk)}=` : "";
...
function encodeDeepObject(key, value, options) {
    ...
    Object.entries(value).forEach(([ck, cv]) => {
        ...
        const pk = `${key}[${ck}]`;
        if ((0, is_plain_object_1.isPlainObject)(cv)) {
...
const encodeSimple = (key, value, options) => {
    ...
    pairs.forEach(([pk, pv]) => {
        ...
        if (pv === undefined) {
            ...
            const k = (options === null || options === void 0 ? void 0 : options.explode) && (0, is_plain_object_1.isPlainObject)(value) ? `${pk}=` : "";
...
function explode(key, value) {
    ...
    else if ((0, is_plain_object_1.isPlainObject)(value)) {
